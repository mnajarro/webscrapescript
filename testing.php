...
for ($x = 0; $x <= 3; $x++) {
	...
	$municipality=str_replace(' ', '-', $munarray[$x]['FIELD1']);

	$html= file_get_contents('http://www.statssa.gov.za/?page_id=1021&id='.$municipality.'-municipality');
	...
	if(!empty($html)){ //if any html is actually returned
		...
		//$data_row2= $data_xpath->query('//div[@id="2011"]//td[2]//text()');
		...
		/*if($data_row2->length > 0){
			foreach($data_row2 as $row2){
				echo $row2->nodeValue . ":";
			}
		}*/
